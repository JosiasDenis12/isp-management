...
<div class="sus-page-header d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
    <div class="d-flex align-items-start gap-3">
        ...
        <div>
            ...
            <div class="text-muted">Consulta vencimientos, próximos cortes y envía recordatorios rápidamente.</div>
        </div>
    </div>
...
(function() {
    ...
    function updateStats() {
        const totals = { total: 0, aldia: 0, porvencer: 0, vencido: 0 };
        rows.forEach(tr => {
            totals.total++;
    ...
    function applyFilters() {
        ...
        rows.forEach(tr => {
            ...
            if (ok && filter !== 'all') {
                if (filter === 'vencidos') ok = st === 'vencido';
